...
| State | Description |
|-------|-------------|
| install-templates | Install required base templates (fedora-43, debian-13) |
...
*   `fedora-43-minimal` - For management (mgmt) and VPN
*   `debian-13-minimal` - For lightweight templates
*   `debian-13` - For full desktop templates
*   `fedora-43` - For network-related templates
